...
namespace Axodox::Graphics
{
  ...
  D3D11_RENDER_TARGET_BLEND_DESC BlendState::GetBlendDescription(BlendType type)
  {
    ...
    case BlendType::OverBlend:
      ...
      result.DestBlendAlpha = D3D11_BLEND_INV_SRC_ALPHA;
      result.BlendOpAlpha = D3D11_BLEND_OP_ADD;
      break;
    case BlendType::OverBlendPreMult:
      result.BlendEnable = true;
      result.SrcBlend = D3D11_BLEND_ONE;
      result.DestBlend = D3D11_BLEND_INV_SRC_ALPHA;
      result.BlendOp = D3D11_BLEND_OP_ADD;
    ...
    case BlendType::Maximum:
      ...
      break;
    case BlendType::Revelage:
      result.BlendEnable = true;
      result.SrcBlend = D3D11_BLEND_ZERO;
      result.DestBlend = D3D11_BLEND_INV_SRC_COLOR;
      result.BlendOp = D3D11_BLEND_OP_ADD;
      result.SrcBlendAlpha = D3D11_BLEND_ZERO;
      result.DestBlendAlpha = D3D11_BLEND_INV_SRC_ALPHA;
      result.BlendOpAlpha = D3D11_BLEND_OP_ADD;
      break;
    case BlendType::UnderBlend:
      result.BlendEnable = true;
      result.SrcBlend = D3D11_BLEND_DEST_ALPHA;
      result.DestBlend = D3D11_BLEND_ONE;
      result.BlendOp = D3D11_BLEND_OP_ADD;
      result.SrcBlendAlpha = D3D11_BLEND_ZERO;
      result.DestBlendAlpha = D3D11_BLEND_INV_SRC_ALPHA;
      result.BlendOpAlpha = D3D11_BLEND_OP_ADD;
      break;
    case BlendType::MBOITCombine:
      result.BlendEnable = true;
      result.SrcBlend = D3D11_BLEND_ONE;
      result.DestBlend = D3D11_BLEND_SRC_ALPHA;
      result.BlendOp = D3D11_BLEND_OP_ADD;
      result.SrcBlendAlpha = D3D11_BLEND_ONE;
      result.DestBlendAlpha = D3D11_BLEND_ZERO;
      result.BlendOpAlpha = D3D11_BLEND_OP_ADD;
