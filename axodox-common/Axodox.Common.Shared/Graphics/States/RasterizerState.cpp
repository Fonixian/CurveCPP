...
{
  RasterizerState::RasterizerState(const GraphicsDevice& device, RasterizerFlags flags, bool scissorTest, int depthBias, float slopeScaledDepthBias) :
    GraphicsResource(device)
  {
    ...
    description.ScissorEnable = scissorTest;
